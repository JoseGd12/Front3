...
export function MetricsChart() {
  return (
    <div className="elegante-card">
      <div className="pb-6">
        <h3 className="text-xl font-bold text-white-primary mb-2">Visibility & Presence Trends</h3>
      ...
      <div>
        <Tabs defaultValue="visibility" className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-8 bg-gray-medium border border-gray-dark">
            <TabsTrigger
              value="visibility"
              className="text-sm font-semibold data-[state=active]:bg-orange-primary data-[state=active]:text-black-primary text-gray-lighter"
            >
              Visibility & Presence
            </TabsTrigger>
            <TabsTrigger
            ...
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={visibilityData} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="var(--color-gray-dark)" />
                  <XAxis
                    dataKey="date"
                  ...
                  <Line
                    ...
                    strokeWidth={3}
                    dot={{ fill: "var(--color-gold-primary)", strokeWidth: 0, r: 5 }}
                    activeDot={{ r: 7, stroke: "var(--color-gold-primary)", strokeWidth: 2, fill: "var(--color-gray-darkest)" }}
                  ...
                  <Line
                    ...
                    stroke="var(--color-gray-lightest)"
                    strokeWidth={3}
                    dot={{ fill: "var(--color-gray-lightest)", strokeWidth: 0, r: 5 }}
                    activeDot={{ r: 7, stroke: "var(--color-gray-lightest)", strokeWidth: 2, fill: "var(--color-gray-darkest)" }}
                    name="Presence %"
                  />
                </LineChart>
              </ResponsiveContainer>
