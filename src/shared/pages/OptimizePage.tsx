...
const donutData = [
  ...
  { name: 'Warnings', value: 5, color: '#d8b081' },
...
const technicalIssues = [
  ...
  { type: "Warnings", count: 5, color: "text-orange-600", bgColor: "bg-orange-50", icon: AlertTriangle },
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            <div className="font-medium text-orange-900">Slow page load speeds</div>
                            <div className="text-sm text-orange-700 mt-1">8 pages need optimization</div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <AccordionContent className="pb-6">
                    <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                      <div className="flex items-start space-x-3">
                        <AlertTriangle className="w-5 h-5 text-orange-600 mt-0.5" />
                        <div>
                          <div className="font-medium text-orange-900">Missing alt text on images</div>
                          <div className="text-sm text-orange-700 mt-1">5 images need descriptions</div>
                        </div>
                      </div>
                    </div>
                  </AccordionContent>
