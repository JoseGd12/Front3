...
class ProductoService {
  ...
  async createProducto(productoData: Partial<ApiProducto>): Promise<ApiProducto> {
    ...
    const apiBody = {
      ...
      StockTotal: (Number(productoData.stockVentas) || 0) + (Number(productoData.stockInsumos) || 0),
